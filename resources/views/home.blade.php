                    ...
                    <div class="card Online-Order">
                        <div class="card-block">
                            ...
                            <h6 class="text-muted d-flex align-items-center justify-content-between m-t-30">
                                Delivery Orders<span class="float-right f-18 text-c-green">237 /
                                    400</span></h6>
                            <div class="progress mt-3">
                                <div class="progress-bar progress-c-theme" role="progressbar" style="width:65%;height:6px;"
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card Online-Order">
                        <div class="card-block">
                            ...
                            <h6 class="text-muted d-flex align-items-center justify-content-between m-t-30">
                                Pending Orders<span class="float-right f-18 text-c-purple">100 /
                                    500</span></h6>
                            <div class="progress mt-3">
                ...
                <div class="col-md-12 col-xl-4">
                    <div class="card Online-Order">
                        <div class="card-block">
                            <h5>Return Orders</h5>
                            <h6 class="text-muted d-flex align-items-center justify-content-between m-t-30">
                                Return Orders<span class="float-right f-18 text-c-blue">50 /
                                    400</span></h6>
                            <div class="progress mt-3">
                            ...
                            <div class="bd-example bd-example-tabs">
                                <div class="tab-content" id="tabContent-pills">
                                    <div class="tab-pane fade show active" id="earnings-mon" role="tabpanel"
                                        ...
                                        <h2 class="text-white mb-3 f-w-300">359,234<i class="feather icon-arrow-up"></i>
                                        </h2>
                                    ...
                                    <div class="tab-pane fade" id="earnings-tue" role="tabpanel"
                                        ...
                                        <h2 class="text-white mb-3 f-w-300">222,586<i class="feather icon-arrow-down"></i>
                                        </h2>
                                        <span class="text-white mb-4 d-block">TOTAL EARNINGS</span>
                                    </div>
                                    <div class="tab-pane fade" id="earnings-wed" role="tabpanel"
                                        aria-labelledby="pills-earnings-wed">
                                        <h2 class="text-white mb-3 f-w-300">859,745<i class="feather icon-arrow-up"></i>
                                        </h2>
                                        <span class="text-white mb-4 d-block">TOTAL EARNINGS</span>
                                    </div>
                                    <div class="tab-pane fade" id="earnings-thu" role="tabpanel"
                                        aria-labelledby="pills-earnings-thu">
                                        <h2 class="text-white mb-3 f-w-300">785,684<i class="feather icon-arrow-up"></i>
                                        </h2>
                                        <span class="text-white mb-4 d-block">TOTAL EARNINGS</span>
                                    </div>
                                    <div class="tab-pane fade" id="earnings-fri" role="tabpanel"
                                        aria-labelledby="pills-earnings-fri">
                                        <h2 class="text-white mb-3 f-w-300">123,486<i class="feather icon-arrow-down"></i>
                                        </h2>
                                        <span class="text-white mb-4 d-block">TOTAL EARNINGS</span>
                                    </div>
                                    <div class="tab-pane fade" id="earnings-sat" role="tabpanel"
                                        aria-labelledby="pills-earnings-sat">
                                        <h2 class="text-white mb-3 f-w-300">762,963<i class="feather icon-arrow-up"></i>
                                        </h2>
                                        <span class="text-white mb-4 d-block">TOTAL EARNINGS</span>
                                    </div>
                                    <div class="tab-pane fade" id="earnings-sun" role="tabpanel"
                                        aria-labelledby="pills-earnings-sun">
                                        <h2 class="text-white mb-3 f-w-300">984,632<i class="feather icon-arrow-down"></i>
                                        </h2>
                                        <span class="text-white mb-4 d-block">TOTAL EARNINGS</span>
                                    </div>
                                </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="#!" class="label theme-bg f-12 text-white">Active</a>
                                            </td>
                                            <td class="text-right"><a href="#!"><i
                                                        class="fa fa-star f-18 text-c-yellow"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#!" class="label theme-bg2 f-12 text-white">Not
                                                    Active</a></td>
                                            <td class="text-right"><a href="#!"><i
                                                        class="fa fa-star f-18 text-c-yellow"></i></a>
                                                <a href="#!"><i class="fa fa-star f-18 text-c-yellow"></i></a>
